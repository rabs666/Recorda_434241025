...
const CMS_DEFAULTS = {
    products: [
        ...
        { key: 'you-seem-pretty-sad', name: 'You Seem Pretty Sad for a Girl So in Love', artist: 'Olivia Rodrigo', year: 2026, format: 'Vinyl', genre: 'Pop', price: 420000, stock: 15, badge: 'New', cover: 'cover-a', hidden: false },
        { key: 'sour', name: 'SOUR', artist: 'Olivia Rodrigo', year: 2021, format: 'CD', genre: 'Pop', price: 195000, stock: 10, badge: 'Ready', cover: 'cover-b', hidden: false },
        { key: 'guts', name: 'GUTS', artist: 'Olivia Rodrigo', year: 2023, format: 'CD', genre: 'Pop', price: 210000, stock: 8, badge: 'Ready', cover: 'cover-c', hidden: false },
        { key: 'midnights', name: 'Midnights', artist: 'Taylor Swift', year: 2022, format: 'Vinyl', genre: 'Pop', price: 480000, stock: 12, badge: 'Limited', cover: 'cover-d', hidden: false },
        { key: 'the-tortured-poets-department', name: 'The Tortured Poets Department', artist: 'Taylor Swift', year: 2024, format: 'CD', genre: 'Pop', price: 225000, stock: 15, badge: 'New', cover: 'cover-a', hidden: false },
        { key: 'short-n-sweet', name: "Short n' Sweet", artist: 'Sabrina Carpenter', year: 2024, format: 'Vinyl', genre: 'Pop', price: 450000, stock: 8, badge: 'New', cover: 'cover-b', hidden: false },
        { key: 'definitely-maybe', name: 'Definitely Maybe', artist: 'Oasis', year: 1994, format: 'Vinyl', genre: 'Rock', price: 460000, stock: 7, badge: 'Collector', cover: 'cover-c', hidden: false },
        { key: 'demon-days', name: 'Demon Days', artist: 'Gorillaz', year: 2005, format: 'Vinyl', genre: 'Alternative', price: 490000, stock: 6, badge: 'Collector', cover: 'cover-d', hidden: false },
        { key: 'parklife', name: 'Parklife', artist: 'Blur', year: 1994, format: 'CD', genre: 'Rock', price: 230000, stock: 5, badge: 'Ready', cover: 'cover-a', hidden: false },
        { key: 'divide', name: 'Divide (÷)', artist: 'Ed Sheeran', year: 2017, format: 'CD', genre: 'Pop', price: 210000, stock: 10, badge: 'Ready', cover: 'cover-b', hidden: false },
        { key: 'nadhif-laman-berikutnya', name: 'Nadhif (Laman Berikutnya)', artist: 'Nadhif Basalamah', year: 2025, format: 'CD', genre: 'I-Pop', price: 165000, stock: 14, badge: 'New', cover: 'cover-c', hidden: false },
        { key: 'menari-dengan-bayangan', name: 'Menari dengan Bayangan', artist: 'Hindia', year: 2019, format: 'CD', genre: 'Indie', price: 170000, stock: 20, badge: 'Ready', cover: 'cover-d', hidden: false },
        { key: 'centralismo', name: 'Centralismo', artist: 'Sore', year: 2005, format: 'Vinyl', genre: 'Indie', price: 470000, stock: 4, badge: 'Collector', cover: 'cover-a', hidden: false },
        { key: 'nelangsa-pasar-turi', name: 'Nelangsa Pasar Turi', artist: 'Bilal Indrajaya', year: 2023, format: 'CD', genre: 'Indie', price: 160000, stock: 12, badge: 'Ready', cover: 'cover-b', hidden: false },
        { key: 'markers-and-such-pens', name: 'MARKERS AND SUCH PENS FLASHDISKS', artist: 'Sal Priadi', year: 2024, format: 'CD', genre: 'Indie', price: 180000, stock: 18, badge: 'New', cover: 'cover-c', hidden: false },
        { key: 'untuk-dunia-cinta-kotornya', name: 'Untuk Dunia, Cinta, dan Kotornya', artist: 'Nadin Amizah', year: 2023, format: 'CD', genre: 'Indie', price: 175000, stock: 15, badge: 'Ready', cover: 'cover-d', hidden: false },
        { key: 'sialnya-hidup-harus-tetap-berjalan', name: 'Sialnya, Hidup Harus Tetap Berjalan', artist: 'Bernadya', year: 2024, format: 'CD', genre: 'I-Pop', price: 165000, stock: 22, badge: 'New', cover: 'cover-a', hidden: false },
        { key: 'with-you-th', name: 'With YOU-th', artist: 'TWICE', year: 2024, format: 'CD', genre: 'K-Pop', price: 215000, stock: 14, badge: 'New', cover: 'cover-b', hidden: false },
        { key: 'memorandum', name: 'Memorandum', artist: 'Perunggu', year: 2022, format: 'CD', genre: 'Rock', price: 160000, stock: 11, badge: 'Ready', cover: 'cover-c', hidden: false },
        { key: 'selamat-datang-di-ujung-dunia', name: 'Selamat Datang di Ujung Dunia', artist: 'Lomba Sihir', year: 2021, format: 'CD', genre: 'Indie', price: 160000, stock: 9, badge: 'Ready', cover: 'cover-d', hidden: false },
        { key: 'lyodra-self-titled', name: 'Lyodra', artist: 'Lyodra', year: 2021, format: 'CD', genre: 'I-Pop', price: 155000, stock: 15, badge: 'Ready', cover: 'cover-a', hidden: false },
        { key: 'rahasia-pertama', name: 'Rahasia Pertama', artist: 'Rony Parulian', year: 2025, format: 'CD', genre: 'I-Pop', price: 160000, stock: 13, badge: 'New', cover: 'cover-b', hidden: false },
        { key: 'reality-club-presents', name: 'Reality Club Presents...', artist: 'Reality Club', year: 2023, format: 'Vinyl', genre: 'Indie', price: 450000, stock: 8, badge: 'Ready', cover: 'cover-c', hidden: false },
        { key: 'motomami', name: 'MOTOMAMI', artist: 'Rosalía', year: 2022, format: 'CD', genre: 'Pop', price: 230000, stock: 7, badge: 'Ready', cover: 'cover-d', hidden: false },
        { key: 'eternal-sunshine', name: 'Eternal Sunshine', artist: 'Ariana Grande', year: 2024, format: 'CD', genre: 'Pop', price: 220000, stock: 12, badge: 'New', cover: 'cover-a', hidden: false },
        { key: 'hit-me-hard-and-soft', name: 'Hit Me Hard and Soft', artist: 'Billie Eilish', year: 2024, format: 'Vinyl', genre: 'Pop', price: 470000, stock: 10, badge: 'New', cover: 'cover-b', hidden: false },
        { key: 'cosmic-red-velvet', name: 'Cosmic', artist: 'Red Velvet', year: 2024, format: 'CD', genre: 'K-Pop', price: 210000, stock: 11, badge: 'New', cover: 'cover-c', hidden: false },
        { key: 'ive-switch', name: 'IVE SWITCH', artist: 'IVE', year: 2024, format: 'CD', genre: 'K-Pop', price: 210000, stock: 14, badge: 'New', cover: 'cover-d', hidden: false },
        { key: 'akibat-pergaulan-blues', name: 'Akibat Pergaulan Blues', artist: 'Jason Ranti', year: 2017, format: 'CD', genre: 'Indie', price: 155000, stock: 8, badge: 'Ready', cover: 'cover-a', hidden: false },
        { key: 'fourever-day6', name: 'Fourever', artist: 'DAY6', year: 2024, format: 'CD', genre: 'K-Pop', price: 215000, stock: 12, badge: 'New', cover: 'cover-b', hidden: false },
        { key: 'buzz-niki', name: 'Buzz', artist: 'NIKI', year: 2024, format: 'Vinyl', genre: 'Pop', price: 460000, stock: 9, badge: 'New', cover: 'cover-c', hidden: false },
        { key: 'nonaria-self-titled', name: 'NonaRia', artist: 'NonaRia', year: 2018, format: 'CD', genre: 'Pop', price: 155000, stock: 6, badge: 'Ready', cover: 'cover-d', hidden: false },
        { key: 'agterplaas-the-adams', name: 'Agterplaas', artist: 'The Adams', year: 2019, format: 'Vinyl', genre: 'Indie', price: 450000, stock: 7, badge: 'New', cover: 'cover-a', hidden: false },
        { key: 'rotasi-the-adams', name: 'Rotasi', artist: 'The Adams', year: 2005, format: 'CD', genre: 'Indie', price: 155000, stock: 10, badge: 'Ready', cover: 'cover-b', hidden: false },
        { key: 'rimpang-erk', name: 'Rimpang', artist: 'Efek Rumah Kaca', year: 2023, format: 'CD', genre: 'Indie', price: 160000, stock: 12, badge: 'Ready', cover: 'cover-c', hidden: false },
        { key: 'kamar-gelap-erk', name: 'Kamar Gelap', artist: 'Efek Rumah Kaca', year: 2009, format: 'CD', genre: 'Indie', price: 155000, stock: 8, badge: 'Ready', cover: 'cover-d', hidden: false },
        { key: 'membangun-menghancurkan-feast', name: 'Membangun & Menghancurkan', artist: '.Feast', year: 2024, format: 'CD', genre: 'Indie', price: 165000, stock: 15, badge: 'New', cover: 'cover-a', hidden: false },
        { key: 'multiverses-feast', name: 'Multiverses', artist: '.Feast', year: 2017, format: 'CD', genre: 'Indie', price: 150000, stock: 6, badge: 'Ready', cover: 'cover-b', hidden: false },
        { key: 'lelaku-fourtwnty', name: 'Lelaku', artist: 'Fourtwnty', year: 2015, format: 'CD', genre: 'Indie', price: 145000, stock: 14, badge: 'Ready', cover: 'cover-c', hidden: false },
        { key: 'nalar-fourtwnty', name: 'Nalar', artist: 'Fourtwnty', year: 2023, format: 'CD', genre: 'Indie', price: 155000, stock: 11, badge: 'Ready', cover: 'cover-d', hidden: false },
        { key: 'taifun-barasuara', name: 'Taifun', artist: 'Barasuara', year: 2015, format: 'CD', genre: 'Indie', price: 155000, stock: 9, badge: 'Ready', cover: 'cover-a', hidden: false },
        { key: 'wsatcc-2020', name: '2020', artist: 'White Shoes & The Couples Company', year: 2020, format: 'Vinyl', genre: 'Indie', price: 440000, stock: 5, badge: 'Ready', cover: 'cover-b', hidden: false },
        { key: 'telisik-danilla', name: 'Telisik', artist: 'Danilla', year: 2014, format: 'CD', genre: 'Indie', price: 150000, stock: 10, badge: 'Ready', cover: 'cover-c', hidden: false },
        { key: 'pop-seblay-danilla', name: 'Pop Seblay', artist: 'Danilla', year: 2022, format: 'CD', genre: 'Indie', price: 160000, stock: 8, badge: 'Ready', cover: 'cover-d', hidden: false },
        { key: 'walk-the-talk-pamungkas', name: 'Walk The Talk', artist: 'Pamungkas', year: 2018, format: 'CD', genre: 'Pop', price: 160000, stock: 15, badge: 'Ready', cover: 'cover-a', hidden: false },
        { key: 'flying-solo-pamungkas', name: 'Flying Solo', artist: 'Pamungkas', year: 2019, format: 'CD', genre: 'Pop', price: 165000, stock: 13, badge: 'Ready', cover: 'cover-b', hidden: false },
        { key: 'the-brandals-self-titled', name: 'The Brandals', artist: 'The Brandals', year: 2003, format: 'CD', genre: 'Rock', price: 145000, stock: 7, badge: 'Ready', cover: 'cover-c', hidden: false },
        { key: 'my-diary-mocca', name: 'My Diary', artist: 'Mocca', year: 2002, format: 'CD', genre: 'Pop', price: 150000, stock: 10, badge: 'Ready', cover: 'cover-d', hidden: false },
        { key: 'folklore-taylor-swift', name: 'folklore', artist: 'Taylor Swift', year: 2020, format: 'Vinyl', genre: 'Pop', price: 470000, stock: 9, badge: 'Limited', cover: 'cover-a', hidden: false },
        { key: 'lover-taylor-swift', name: 'Lover', artist: 'Taylor Swift', year: 2019, format: 'CD', genre: 'Pop', price: 210000, stock: 12, badge: 'Ready', cover: 'cover-b', hidden: false },
        { key: 'reputation-taylor-swift', name: 'reputation', artist: 'Taylor Swift', year: 2017, format: 'CD', genre: 'Pop', price: 215000, stock: 8, badge: 'Ready', cover: 'cover-c', hidden: false },
        { key: 'red-taylors-version', name: 'Red (Taylor\'s Version)', artist: 'Taylor Swift', year: 2021, format: 'Vinyl', genre: 'Pop', price: 520000, stock: 6, badge: 'Limited', cover: 'cover-d', hidden: false },
        { key: '1989-taylors-version', name: '1989 (Taylor\'s Version)', artist: 'Taylor Swift', year: 2023, format: 'Vinyl', genre: 'Pop', price: 490000, stock: 11, badge: 'Limited', cover: 'cover-a', hidden: false },
        { key: 'multiply-ed-sheeran', name: 'x (Multiply)', artist: 'Ed Sheeran', year: 2014, format: 'CD', genre: 'Pop', price: 195000, stock: 9, badge: 'Ready', cover: 'cover-b', hidden: false },
        { key: 'plus-ed-sheeran', name: '+ (Plus)', artist: 'Ed Sheeran', year: 2011, format: 'CD', genre: 'Pop', price: 185000, stock: 5, badge: 'Ready', cover: 'cover-c', hidden: false },
        { key: 'equals-ed-sheeran', name: '= (Equals)', artist: 'Ed Sheeran', year: 2021, format: 'CD', genre: 'Pop', price: 200000, stock: 10, badge: 'Ready', cover: 'cover-d', hidden: false },
        { key: 'subtract-ed-sheeran', name: '- (Subtract)', artist: 'Ed Sheeran', year: 2023, format: 'Vinyl', genre: 'Pop', price: 450000, stock: 7, badge: 'Limited', cover: 'cover-a', hidden: false },
        { key: 'guts-spilled', name: 'GUTS (spilled)', artist: 'Olivia Rodrigo', year: 2024, format: 'Vinyl', genre: 'Pop', price: 480000, stock: 8, badge: 'Limited', cover: 'cover-b', hidden: false },
        { key: 'girls-aespa', name: 'Girls', artist: 'aespa', year: 2022, format: 'CD', genre: 'K-Pop', price: 190000, stock: 14, badge: 'Ready', cover: 'cover-c', hidden: false },
        { key: 'my-world-aespa', name: 'MY WORLD', artist: 'aespa', year: 2023, format: 'CD', genre: 'K-Pop', price: 195000, stock: 12, badge: 'Ready', cover: 'cover-d', hidden: false },
        { key: 'get-up-newjeans', name: 'Get Up', artist: 'NewJeans', year: 2023, format: 'CD', genre: 'K-Pop', price: 190000, stock: 18, badge: 'Ready', cover: 'cover-a', hidden: false },
        { key: 'how-sweet-newjeans', name: 'How Sweet', artist: 'NewJeans', year: 2024, format: 'CD', genre: 'K-Pop', price: 195000, stock: 15, badge: 'New', cover: 'cover-b', hidden: false },
        { key: 'kill-this-love-blackpink', name: 'Kill This Love', artist: 'BLACKPINK', year: 2019, format: 'CD', genre: 'K-Pop', price: 200000, stock: 9, badge: 'Ready', cover: 'cover-c', hidden: false },
        { key: 'proof-bts', name: 'Proof', artist: 'BTS', year: 2022, format: 'CD', genre: 'K-Pop', price: 290000, stock: 10, badge: 'Ready', cover: 'cover-d', hidden: false },
        { key: 'seventeen-is-right-here', name: '17 IS RIGHT HERE', artist: 'SEVENTEEN', year: 2024, format: 'CD', genre: 'K-Pop', price: 250000, stock: 14, badge: 'New', cover: 'cover-a', hidden: false },
        { key: 'the-book-of-us-entropy', name: 'The Book of Us: Entropy', artist: 'DAY6', year: 2019, format: 'CD', genre: 'K-Pop', price: 210000, stock: 8, badge: 'Ready', cover: 'cover-b', hidden: false },
        { key: 'band-aid-day6', name: 'Band Aid', artist: 'DAY6', year: 2024, format: 'CD', genre: 'K-Pop', price: 215000, stock: 15, badge: 'New', cover: 'cover-c', hidden: false },
        { key: 'manusia-tulus', name: 'Manusia', artist: 'Tulus', year: 2022, format: 'CD', genre: 'Pop', price: 160000, stock: 14, badge: 'Ready', cover: 'cover-a', hidden: false },
        { key: 'mantra-mantra-kunto-aji', name: 'Mantra Mantra', artist: 'Kunto Aji', year: 2018, format: 'CD', genre: 'Pop', price: 155000, stock: 10, badge: 'Ready', cover: 'cover-b', hidden: false },
        { key: 'sentimental-juicy-luicy', name: 'Sentimental', artist: 'Juicy Luicy', year: 2020, format: 'CD', genre: 'Pop', price: 145000, stock: 12, badge: 'Ready', cover: 'cover-c', hidden: false },
        { key: 'kisah-klasik-sheila-on-7', name: 'Kisah Klasik Untuk Masa Depan', artist: 'Sheila On 7', year: 2000, format: 'Kaset', genre: 'Pop', price: 125000, stock: 5, badge: 'Ready', cover: 'cover-d', hidden: false },
        { key: 'bintang-lima-dewa-19', name: 'Bintang Lima', artist: 'Dewa 19', year: 2000, format: 'Vinyl', genre: 'Rock', price: 500000, stock: 6, badge: 'Limited', cover: 'cover-a', hidden: false },
        { key: 'new-jeans-ep', name: 'New Jeans', artist: 'NewJeans', year: 2022, format: 'CD', genre: 'K-Pop', price: 185000, stock: 15, badge: 'Ready', cover: 'cover-b', hidden: false },
        { key: 'unforgiven-le-sserafim', name: 'UNFORGIVEN', artist: 'LE SSERAFIM', year: 2023, format: 'CD', genre: 'K-Pop', price: 200000, stock: 11, badge: 'Ready', cover: 'cover-c', hidden: false },
        { key: 'ive-ive-album', name: 'I\'ve IVE', artist: 'IVE', year: 2023, format: 'CD', genre: 'K-Pop', price: 205000, stock: 13, badge: 'Ready', cover: 'cover-d', hidden: false },
        { key: 'armageddon-aespa', name: 'Armageddon', artist: 'aespa', year: 2024, format: 'CD', genre: 'K-Pop', price: 210000, stock: 16, badge: 'New', cover: 'cover-a', hidden: false },
        { key: 'ready-to-be-twice', name: 'READY TO BE', artist: 'TWICE', year: 2023, format: 'CD', genre: 'K-Pop', price: 200000, stock: 14, badge: 'Ready', cover: 'cover-b', hidden: false },
        { key: 'ate-stray-kids', name: 'ATE', artist: 'Stray Kids', year: 2024, format: 'CD', genre: 'K-Pop', price: 215000, stock: 18, badge: 'New', cover: 'cover-c', hidden: false },
        { key: 'when-we-all-fall-asleep-billie-eilish', name: 'WHEN WE ALL FALL ASLEEP, WHERE DO WE GO?', artist: 'Billie Eilish', year: 2019, format: 'Vinyl', genre: 'Pop', price: 460000, stock: 8, badge: 'Limited', cover: 'cover-d', hidden: false },
        { key: 'happier-than-ever-billie-eilish', name: 'Happier Than Ever', artist: 'Billie Eilish', year: 2021, format: 'Vinyl', genre: 'Pop', price: 470000, stock: 9, badge: 'Limited', cover: 'cover-a', hidden: false },
        { key: 'future-nostalgia-dua-lipa', name: 'Future Nostalgia', artist: 'Dua Lipa', year: 2020, format: 'Vinyl', genre: 'Pop', price: 450000, stock: 7, badge: 'Limited', cover: 'cover-b', hidden: false },
        { key: 'emails-i-cant-send-sabrina-carpenter', name: 'Emails I Can\'t Send', artist: 'Sabrina Carpenter', year: 2022, format: 'CD', genre: 'Pop', price: 190000, stock: 10, badge: 'Ready', cover: 'cover-c', hidden: false },
        { key: 'thank-u-next-ariana-grande', name: 'thank u, next', artist: 'Ariana Grande', year: 2019, format: 'CD', genre: 'Pop', price: 195000, stock: 12, badge: 'Ready', cover: 'cover-d', hidden: false },
    ],
    articles: [
